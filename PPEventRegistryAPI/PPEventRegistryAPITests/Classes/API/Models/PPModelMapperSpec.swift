    ...
    override func spec() {
        describe("Initialization") {
            ...
            it("Maps articls correctly") {
                let article: PPArticle = modelMapper.mapDataToModelObject(JSON(PPArticle.fixture1()))
            ...
            it("Maps events correctly") {
                let event: PPEvent = modelMapper.mapDataToModelObject(JSON(PPEvent.fixture1()))
